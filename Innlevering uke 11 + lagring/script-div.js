let arr1 = [10, 20, 30, 40, 50, 100]; //lager en array som tall1 velges tilfeldig ut ifra, og en array som tall2 velges tilfeldig ut ifra. tall1 må være delelig på tall2, så valgte tall utifra det. lagde derfor et eget script til divisjonsnettsiden, for å ikke krasje med den andre koden
let arr2 = [1, 2, 5, 10] //ULIKT FRA ANDRE SCRIPTET
...
// Funksjon som henter nytt regnestykke, ULIK FRA ANDRE SCRIPTET
function nyttRegnestykke(){
    tall1 = arr1[Math.floor(Math.random() * arr1.length)] //velger tilfeldige tall fra arrayene
    document.querySelector(".tall1").innerHTML = tall1;
    //console.log(tall1);

    tall2 = arr2[Math.floor(Math.random() * arr2.length)]
